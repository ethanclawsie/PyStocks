...
def question():
    option = input(
        "Would you like to see portfolio, compare portfolios, or get help? (portfolio/compare/help): "
    )
    if option == "portfolio":
        ...
        print(
            "You can add as many stocks as you want, just make sure to add a new line for each stock"
        )
        print(
            "You can also compare two portfolios by entering the name of the txt file you want to compare against"
        )
